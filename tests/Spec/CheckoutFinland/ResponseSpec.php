...
class ResponseSpec extends ObjectBehavior
{
    ...
    public function it_can_set_all_variables_from_array()
    {
        $this->setRequestParams($this->valid_response_params);
    }

    public function it_returns_true_on_validation_when_given_valid_request_parameters()
    {
        $this->setRequestParams($this->valid_response_params);
    ...
    public function it_throws_mac_mismatch_exception_when_given_invalid_parameters()
    {
    ...
    public function it_throws_unsupported_algorithm_exception_when_using_old_algorithm()
    {
    ...
    public function its_variables_are_all_accessible_trough_setters_and_getters()
    {
        $this->setAlgorithm(3);
